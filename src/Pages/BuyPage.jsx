...
function BuyPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <header className="bg-primary text-primary-foreground py-4 px-4 sm:px-6 shadow">
      ...
      <main className="flex-1 bg-background">
        <section className="py-12 px-4 sm:px-6">
          <div className="container mx-auto max-w-6xl">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 text-red-600">
              Buy a Car
            </h1>
                  ...
                  <div className="space-y-4">
                    {cars.slice(0, 2).map((car, index) => (
                      <div key={index} className="bg-muted p-4 rounded-lg">
                        ...
                        <button className="p-3 bg-red-600 text-white rounded-md hover:bg-red-800 transition-colors duration-300">
                          Buy Now
                        </button>
                      </div>
                    ))}
